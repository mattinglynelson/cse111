...
lame_student = ["sally", "anderson", 421341234]

emergency_contact = {"name": "Johnny Anderson", "phone": "555-555-5555"}

student = {"first_name": "Sally", 
           "last_name": "Anderson", 
           "phone": 1414148154, 
           "contact": emergency_contact,
           "isActive": True,
           "classList": [13,123,13,123,12],
           "iNumber": "88-888888",
           "ward_information": {"ward_name": "1st ward", "stake_id": 65744}
           }


students = [student]
print(student["contact"]["name"])
print(student["classList"][0])
...
speaker = {
    ...
    "title": "Prophet",
    "link": "churchofjesuschrist.org/141241",
    "id": 141241
}

talk = {
    "transcript": "adslkjfnasljkdfadsfasdf",
    "title": "Awesome",
    "topic": "asdfasdf",
    "speaker_id": 141241,
    "video_link": "sdfasdf.mp4"
}

talk2 = {
    "transcript": "asfasf.asdf.asd.fasf",
    "title": "Awesome Oaks",
    "topic": "asdfasdf",
    "speaker_id": 412341234,
    "video_link": "asdfasd.mp4"
}

conference = {
    "year": 2022,
    "month": "April",
    "sessions": "Sunday morning",
    "speakers": [speaker],
    "talks": [talk, talk2]
}
...
elements = [
    ...
    {"symbol":"Zr", "name": "Zirconium", "mass": 91.224}
]

user_input = input("please enter an atomic symbol: ")

for element in elements:
    if element["symbol"] == user_input:
        print(f"the mass is {element['mass']}")